...
def intersectionoftwolines_x(m1, b1, m2, b2):
    ...
    x = (b2-b1)/(m1-m2) #calculation for x
    return x
...
def intersectionoftwolines_y(m1, b1, m2, b2):
    ...
    y = (m1*((b2-b1)/(m1-m2)))+b1 #calculation for y
    return y
...
def areaofatriangle(m1, b1, m2, b2, m3, b3):
    ...
    if (m1 == m2) or (m2 == m3) or (m1 == m3):
        #The slopes are equal, so there is no triangle
        print("Error = There are parallel lines")
        return None
        ...
        if (a==0) or (b==0) or (c==0):
            print("Error = Lines intersect at same point")
            return None
...
print("Parallel Line Test:")
#If this is true, it is likely that your function is working.
print(areaofatriangle(2, 10, 2, 5, 30, 0))
print("*********")

print("Lines All Intersect Test:")
#If this is true, it is likely that your function is working.
print(areaofatriangle(2, 1, 1, 1, 5, 1))
print("*********")